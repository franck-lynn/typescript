...
const LR_PAGE_MARGIN = 0.15
const TB_PAGE_MARGIN = 0.6
const HF_PAGE_MARGIN = 0.15
...
/*
 ...
 ! 备注: 4 8
 */
const _width = [4, 6.25, 2, 3, 24, 2.25, 2, 9, 5, 5, 8, 4, 8]
export const widths = map((x: number) => x)(_width)
