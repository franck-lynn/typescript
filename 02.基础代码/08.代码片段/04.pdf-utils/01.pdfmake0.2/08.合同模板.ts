      ...
      table: {
        ...
        body: [
          [
            ...
            { text: "杭州德美瑞数控工具有限公司", border: [false, false, false, true], margin: [0, ROW_MARGIN] },
            { text: "合 同 编号: ", border: [false, false], margin: [0, ROW_MARGIN] },
            { text: "HTHZLRY20230312-000688", border: [false, false, false, true], margin: [0, ROW_MARGIN] },
            { text: "FF", border: [false, false, false, true], margin: [0, ROW_MARGIN] },
          ],
          [
            { text: "需      方: ", border: [false, false], margin: [0, 2] },
            { text: "北京金万众科技股份有限公司", border: [false, false, false, true], margin: [0, 2] },
            { text: "日      期: ", border: [false, false], margin: [0, 2] },
            { text: "2023-03-12 15:35:21", colSpan: 2, border: [false, false, false, true], margin: [0, 2] },
          ],
          [
            { text: "经供需双方协商达成如下协议,并签定本合同.", colSpan: 2, border: [false, false], margin: [0, 2] },
            "",
            { text: "客户订单号:", border: [false, false], margin: [0, 2] },
            { text: "", colSpan: 2, border: [false, false, false, true], margin: [0, 2] },
          ],
        ],
      },
    },
