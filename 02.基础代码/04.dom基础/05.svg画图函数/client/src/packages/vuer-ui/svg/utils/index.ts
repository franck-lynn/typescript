 ...
 * @returns
 */
function _createArc(p1: Point, p2: Point, p3: Point, options: OptionsArc) {
...
export function useRotate(
  ...
  const start = (e: PointerEvent) => {
    ...
    flag = true
    // a = e.clientX - center.x
    // b = e.clientY - center.y
    // 计算出此时向量的角度
    // theta = (Math.atan2(b, a) * 180) / Math.PI + 90 - defaultAngle
    options.onStart?.(e)
