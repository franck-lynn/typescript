...
import { IS_NARROW, LEFT_SIDE_WIDTH, MIN_WIDTH, useHorizontalMovable } from "./useHorizontalMovable"
import { resizableIsNarrow, resizableLeftSideWidth, useWindowResizable, resizeFlag } from "./useWindowResizable"

const el = ref<HTMLElement | null>(null)
const { position: x, isNarrow } = useHorizontalMovable(el) // 函数内部有个最小宽度默认值, 也可以不用设置
...
.separator {
  ...
  border: transparent;
  cursor: col-resize;
  background-color: red; /* TOTO: 暂时的标记 */
