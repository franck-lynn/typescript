import { expect } from "chai"; // 这是一个 esm 模块, 如何在 mocha 中得到支持?

import fetch from 'node-fetch'; // const fetch = (...args) => import('node-fetch').then(({default: fetch}) => fetch(...args));
...
describe("异步代码测试", function () {
  ...
  // it("测试应该在 2000ms 后结束", function (done: Mocha.Done) {
  //     let x = true
  //     const f = function () {
  //         x = false
