...
const config: UserConfig = {
  // publicDir: string 配置静态资源的目录,
  // 以项目的 client 下的一级目录作为根目录.
  // 默认是 public 目录, vite 启动一个服务器, 可以在这个目录访问到.
  // 在项目中,也可以通过绝对路径的方式访问到, 例如:
  // <img class="h-12 w-12" src="../../assets/pic3.jpg" alt="ChitChat Logo" />
  // publicDir: "./src/scss/images",
  plugins: [
    vue(),
    Components({
